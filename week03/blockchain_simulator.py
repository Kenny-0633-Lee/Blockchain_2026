...
=============================================================
 ...
 실행 방법:
   python week03_blockchain_simulator.py
...
def solution_notes():
    ...
    notes = [
        ...
        "3주차 예고: Merkle Tree로 TX 변조를 더 효율적으로 검증하는 방법",
    ]
...
if __name__ == "__main__":
    ...
    print("  실습 완료! 실행 화면을 캡처하여 LMS에 제출하세요.")
    print()
